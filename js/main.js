(function($){
  ...
  //pop window(Daniel)
  function agronomic(){
		//open pop window(Daniel)
		$("a[loadPopUrl]").click(function(){
			//set scorll value
			$scorll=$(document).scrollTop();
			loadHtml($(this).attr("loadPopUrl"));
		});
  }
  ...
  function loadHtml(url) {
            $(".agronomicClass").show();
			$("#agrContext").html("<iframe src="+url+" width='100%'  height='100%'>");
